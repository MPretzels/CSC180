...
public class InMemoryAuctionService implements AuctionService {
	...
	public Auction[] search(String criteria) {
		...
		if (criteria != null || criteria.equals("")) {
			CollectionUtils cold = new CollectionUtils();
			ContainsPredicate pred = new ContainsPredicate(criteria);
			cold.filter(auctions.values(), pred);
		}
	...
	public static void main(String[] args) {
			...
			InMemoryAuctionService ma = new InMemoryAuctionService();
			System.out.println(Arrays.toString(ma.search("Broccoli")));
